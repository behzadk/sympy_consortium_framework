...
def main():
    ...
    model_space = model_space_generator.model_space(strain_ids=strain_ids, microcin_objects=microcin_objects, AHL_objects=AHL_objects, 
        substrate_objects=substrate_objects, antitoxin_objects=antitoxin_objects, immunity_objects=immunity_objects, 
        toxin_objects=toxin_objects, max_microcin_parts=max_microcin_parts, max_AHL_parts=max_AHL_parts,
        max_substrate_dependencies=max_substrate_parts, max_antitoxins=max_antitoxins,
        max_immunity=max_immunity_parts, max_toxins=max_toxin_parts, max_microcin_sensitivities=max_microcin_sensitivities)
    ...
    part_combos = model_space.generate_part_combinations(
        strain_max_microcin=strain_max_microcin, strain_max_AHL=strain_max_AHL, strain_max_sub_dependencies=strain_max_sub_dependencies, 
        strain_max_microcin_sens=strain_max_microcin_sens, strain_max_sub_production=strain_max_sub_production, strain_max_antitoxin=strain_max_antitoxin, 
