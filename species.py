...
class Strain:
    def __init__(self, strain_id, microcin_expression, AHL_expression, substrate_dependences, microcin_sensitivities, substrate_production, antitoxins, immunity_expression, toxin_expression):
        self.id = strain_id
