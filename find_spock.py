...
def alt_spock():
	...
	for f in adj_mat_files:
		...
		# No bacteriocin
		if not mat[B_1_idx][N_1_idx] == 0:
			is_spock = False

		# Induces AT
		if not mat[T_1_idx][A_1_idx] == 1:
			is_spock = False

		# Has immunity
		if not mat[V_1_idx][N_1_idx] == 1:
			is_spock = False

		# Repress expression of antitoxin
		if not mat[V_1_idx][A_1_idx] == -1:
			is_spock = False

		if not mat[T_1_idx][N_1_idx] == 1:
			is_spock = False
		
		# Kills N1
		if not mat[N_1_idx][T_1_idx] == -1:
			is_spock = False
